...
public class DatosCampeonatoFinPrematuro {
    ...
    private void initData() {
        ...
        organizacion.setLimiteAbandonos(1);
        organizacion.setLimitePilotos(3);
        ...
        organizacion.setOrganizacionCircuitos(new ComparateComplejiadDesc());
        ...
        peugeot.SetEstrategiaPilotos(new EstrategiaPilotosDesc());
        //ordenaciónCoches: DESCENDENTE por Combustible restante del Coche , en caso de empate por nombre);
        peugeot.SetEstrategiaCoches(new EstrategiaCochesDesc());
        ...
        citroen.SetEstrategiaPilotos(new EstrategiaPilotosAsc());
        //ordenaciónCoches: ASCENDETE Combustible restante del Coche , en caso de empate por nombre);
        citroen.SetEstrategiaCoches(new EstrategiaCochesAsc());
        ...
        //ordenaciónPilotos: DESCENDENTE por Puntos del Piloto, en caso de empate por Destreza, en caso de empate por nombre
        seat.SetEstrategiaPilotos(new EstrategiaPilotosDesc());
        //ordenaciónCoches: DESCENDENTE por Combustible restante del Coche , en caso de empate por nombre);
        seat.SetEstrategiaCoches(new EstrategiaCochesDesc());
