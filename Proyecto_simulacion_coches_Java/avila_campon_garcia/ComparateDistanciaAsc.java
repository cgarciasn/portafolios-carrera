...
public class ComparateDistanciaAsc extends ComparateOfCircuitos{
    /**
    ...
    public int compare(Circuito cir1, Circuito cir2){
        if(cir1.getDistanciaActual().equals(cir2.getDistanciaActual())){
            return cir1.getNombre().compareTo(cir2.getNombre());
        }else{
            return cir1.getDistanciaActual().compareTo(cir2.getDistanciaActual());
        }
    }
}
