...
public interface RestaurantDAO {
	...
	/**
	 * Gets all the restaurants from the database that are located in the same city.
	 * 
	 * @param idu
	 *            User identifier.
	 * 
	 * @return List of all the restaurants from the database that are from that city
	 */	
	public List<Restaurant> getAllBySearchCity(String city);
